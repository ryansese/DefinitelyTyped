...
* Definitions by: Ryan Simone Sese <https://github.com/ryansese>
...
interface MouseInput extends HammerInput {
    constructor(manager:HammerManager, callback:Function);
}

interface PointerEventInput extends HammerInput {
    constructor(manager:HammerManager, callback:Function);
}

interface SingleTouchInput extends HammerInput {
    constructor(manager:HammerManager, callback:Function);
}

interface TouchInput extends HammerInput {
    constructor(manager:HammerManager, callback:Function);
}

interface TouchMouseInput extends HammerInput {
    constructor(manager:HammerManager, callback:Function);
}
...
declare module "hammerjs" {
    function hammerjs(element: any, options?:HammerOptions)
    module hammerjs {
